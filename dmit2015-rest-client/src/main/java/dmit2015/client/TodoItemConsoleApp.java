...
public class TodoItemConsoleApp {
    ...
    public static void findTodoItemById(TodoItemRetrofitClient webClient, Long todoItemId) {
    ...
    public static void createTodoItem(TodoItemRetrofitClient webClient, String name) {
    ...
    public static void fetchTodoItems(TodoItemRetrofitClient webClient) {
