 ...
 * curl -i -X POST http://localhost:8080/dmit2015-instructor-jaxrs-demo/webapi/batch-jobs/batchletEnforcementZoneCentre
 * Example: Find the status of batch job 1
 * curl -i -X GET http://localhost:8080/dmit2015-instructor-jaxrs-demo/webapi/batch-jobs/1
 * Example: Get a set of batch job names
 * curl -i -X GET http://localhost:8080/dmit2015-instructor-jaxrs-demo/webapi/batch-jobs/jobnames
 */
